...
3. You can explore the project contents and download it file by file or you can download the whole repository by using the "Clone or download button". Choose to download the whole project as a .ZIP file
